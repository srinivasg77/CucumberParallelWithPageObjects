package com.common.zoho.ExtentListeners;
...
public class ExtentManager {
    ...
    public synchronized static ExtentReports getReporter() {
        if (extent == null) {
	        ...
	        extent.setSystemInfo("Automation Tester", "Srinivasa Rao Gorantla");
	        extent.setSystemInfo("Organization", "BDD Automation");
	        extent.setSystemInfo("Build no", "BDD-1234");
        }
        return extent;
    }
